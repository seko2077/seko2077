...
def generate_svg(mode):
  ...
  <defs>
    ...
    <filter id="melt-glitch" x="-10%" y="-20%" width="120%" height="140%">
      <!-- vertical melt without destroying text (removed chromatic aberration duplication) -->
      ...
      <feDisplacementMap in="SourceGraphic" in2="noise" scale="3" xChannelSelector="R" yChannelSelector="G">
        <animate attributeName="scale" values="1;4;1;3;1" dur="0.5s" repeatCount="indefinite"/>
      </feDisplacementMap>
    </filter>
    <!-- Pill gradients -->
    {pg}
  ...
  <g font-family="'Hacked', 'Impact', sans-serif" text-anchor="middle" letter-spacing="2">
    ...
    <text x="{LP//2}" y="80" font-size="48" font-weight="900" fill="{GRN}" filter="url(#melt-glitch)">
      whoami
  ...
  <g transform="translate({LP + 44}, 32)">
    ...
    out = os.path.join(HERE, f"seko8_{mode}.svg")
